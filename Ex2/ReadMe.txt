================================================================================
    MICROSOFT 基础类库 : Ex2 项目概述
===============================================================================

应用程序向导已为您创建了此 Ex2 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
Ex2.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CEx2App 应用程序类。

Ex2.cpp
    这是包含应用程序类 CEx2App 的主应用程序源文件。

Ex2.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源包含在 2052 中。

res\Ex2.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 Ex2.rc 中。
...
Ex2Dlg.h、Ex2Dlg.cpp - 对话框
    这些文件包含 CEx2Dlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 Ex2.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
