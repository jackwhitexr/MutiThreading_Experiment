...
BEGIN_MESSAGE_MAP(CEx2Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDVALIDATION, &CEx2Dlg::OnBnClickedValidation)
	ON_BN_CLICKED(IDREGISTER, &CEx2Dlg::OnBnClickedRegister)
END_MESSAGE_MAP()
...
void CEx2Dlg::OnBnClickedValidation()
{
	Validation va;
	va.DoModal();
}
...
void CEx2Dlg::OnBnClickedRegister()
{
	Register re;
	re.DoModal();
}
